...
$router->addRoute("GET", "/diceTest", "\Mos\Controller\DiceTest");
$router->addRoute("GET", "/index_dicegraphic", "\Mos\Controller\DiceGraphic");
$router->addRoute("GET", "/index", "\Mos\Controller\Game21");
